                                                ...
                                                <div className="text-center space-y-8">
                                                    ...
                                                    <div className="space-y-6 mt-12">
                                                        <div className="bg-gradient-to-r from-amber-50 to-orange-50 border-2 border-gold/40 p-6 rounded-lg shadow-lg">
                                                            ...
                                                            <p className="font-montserrat text-xs text-amber-800 mt-2 tracking-widest uppercase">11:00 AM - 5:00 PM</p>
                                                        </div>
                                                        <div className="bg-gradient-to-r from-amber-50 to-orange-50 border-2 border-gold/40 p-6 rounded-lg shadow-lg">
                                                            ...
                                                            <p className="font-montserrat text-xs text-amber-800 mt-2 tracking-widest uppercase">5:00 PM - Closing</p>
                                                        </div>
                                                    </div>
