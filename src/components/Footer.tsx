        ...
        <footer className="bg-black text-white py-12 border-t border-white/10">
            <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
                <div className="mb-6 md:mb-0 text-center md:text-left">
                    <h2 className="font-cinzel text-2xl font-bold text-white">PURE INDIAN CUISINE</h2>
                ...
                <div className="flex flex-wrap justify-center gap-6 md:gap-8 mb-6 md:mb-0 text-sm text-gray-400 font-montserrat">
                    <Link href="/food-menu" className="hover:text-gold transition-colors">Menu</Link>
                ...
                <div className="text-gray-600 text-xs font-montserrat">
                    &copy; {new Date().getFullYear()} Pure Indian Cuisine. All rights reserved.
                </div>
            </div>
        </footer>
    );
