...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Best Indian food in Las Vegas! Authentic North Indian cuisine, all-you-can-eat buffet, family-style dinner, and banquet hall. Located at 1405 E Sunset Rd near Las Vegas airport. Open daily 11am-10pm.",
    images: [
      {
        url: "/icon.jpg",
        width: 512,
  ...
  twitter: {
    ...
    title: "Pure Indian Cuisine Las Vegas | Best Indian Food Restaurant Near Airport",
    description: "Best Indian food in Las Vegas! Authentic North Indian cuisine, all-you-can-eat buffet, family-style dinner, and banquet hall. Open daily 11am-10pm.",
